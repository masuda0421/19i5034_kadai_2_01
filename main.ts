...
forever(function () {
    music.setTempo(10)
    music.playTone(66, music.beat(BeatFraction.Sixteenth))
    music.playTone(74, music.beat(BeatFraction.Sixteenth))
    music.playTone(83, music.beat(BeatFraction.Sixteenth))
    music.playTone(88, music.beat(BeatFraction.Sixteenth))
    music.playTone(98, music.beat(BeatFraction.Sixteenth))
